...
//   - decimal(10,2) 与现有 Auction.CurrentPrice 一致；Go 侧使用 shopspring/decimal
//     避免 float64 精度漂移在跨字段计算时放大。
...
type UserBalance struct {
	...
	AvailableAmount decimal.Decimal `json:"available_amount" gorm:"type:decimal(10,2);default:0"`
	FrozenAmount    decimal.Decimal `json:"frozen_amount" gorm:"type:decimal(10,2);default:0"`
