...
func InitDB(cfg *Config) (*gorm.DB, error) {
	...
	// 注册 SQL 查询耗时监控插件
	sqlMetrics := dbmetrics.InitSQLMetrics("auction-service")
	if err := db.Use(dbmetrics.NewGormMetricsPlugin("auction-service", sqlMetrics)); err != nil {
