---
description: Mobile project standard commit — stage, generate conventional commit message, and push
...
Mobile projects commonly use submodules for modular architecture.
