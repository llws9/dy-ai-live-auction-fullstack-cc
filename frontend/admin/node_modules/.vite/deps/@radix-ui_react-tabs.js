...
function createSlot3(ownerName) {
  ...
  const Slot22 = React14.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime11.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React14.isValidElement(newElement) ? React14.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var TabsContent = React16.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime13.jsx)(
      Primitive2.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
