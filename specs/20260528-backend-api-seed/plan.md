...
**Feature**: `[FEATURE_NAME]` | **Date**: [DATE] | **Spec**: [link]
**Input**: Feature specification from `/specs/[FEATURE_NAME]/spec.md`

**Note**: This template is filled in by the `/adk:sdd:plan` command. See `.ttadk/plugins/ttadk/core/commands/adk/sdd/plan.md` for the execution workflow.
